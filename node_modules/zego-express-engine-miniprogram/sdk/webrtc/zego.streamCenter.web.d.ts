...
import { MediaStreamConstraints, webPlayOption, SignalInfo, ScreenConfig, ERRO, webPublishOption, ChargeInfos, Constraints } from '../common/zego.entity';
...
export declare class ZegoStreamCenterWeb extends ZegoStreamCenter {
    ...
    constructor(log: LoggerWeb, stateCenter: StateCenter, dataReport: ZegoDataReport);
